---
id: the-cpu-oracle
source: 4ee46f6e2870abfb09adcd85e1701f295d69e73894f48acfd64adfce877024d3
sourceLine: 1252
---
...
연산이 있는 모듈이라도 주입된 가드 텍스처에는 값을 줄 필요가 없습니다. 함수가 읽는데도
...
됩니다. `f64` 값은 이쪽에서는 JavaScript 숫자 하나입니다. GPU에서는 이를 f32 레인의
상위·하위 쌍으로 나르며, `splitF64(x)`는 호스트가 버퍼에 채워 넣을 수 있도록 그 쌍을
돌려줍니다. 그래서 양쪽은 같은 값을 각자에게 필요한 형태로 나타냅니다.
...
약 48개를 나르는 f32 레인 쌍으로 실행됩니다. 이런 모듈에 대해서는 WGSL, GLSL, CPU의
결과가 그 폭 안에서 일치합니다.
