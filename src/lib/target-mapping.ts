...
function buildWgsl(): WgslMapping {
  ...
  // `f16` has no name in this surface and no capability an author can declare, so its row is
  // written here. The profile is checked against the words the copy uses for it, and a change
