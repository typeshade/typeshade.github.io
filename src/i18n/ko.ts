...
export const ko: Copy = {
  ...
  playground: {
    h1: 'Playground',
    intro: 'TypeShade TypeScript 파일을 작성하고 브라우저에서 컴파일한 뒤, WGSL과 GLSL, 리플렉션, 진입점이 내는 값을 확인하십시오.',
    ...
    runner: {
      ...
      execute: 'CPU에서 실행',
      result: '결과',
      noEntries: '이 모듈에는 진입점이 없습니다.',
      unsupported: '이 진입점의 인자 중에 폼이 채울 수 없는 타입이 있습니다.',
      failed: '진입점을 실행하지 못했습니다.',
      idle: '진입점을 고르고 실행하십시오.',
    },
  },
