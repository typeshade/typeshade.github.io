...
export const ko: Copy = {
  ...
  playground: {
    ...
    gpuNeedsBindings: '캔버스가 채우는 것은 유니폼 블록과 컴파일러가 넣는 f64 가드뿐입니다. 이 모듈은 {names}을(를) 요구하므로 여기서는 GPU로 실행할 수 없습니다.',
    gpuZeroed: '페이지는 프레임마다 time, resolution, mouse를 채웁니다. 이 모듈은 {fields}도 선언하는데, 여기에 맞는 손잡이가 없어 0으로 둡니다.',
    uniforms: '유니폼',
    draw: 'CPU로 그리기',
    stop: '중지',
