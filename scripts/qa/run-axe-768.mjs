// Regression-audit addendum: run-axe.mjs only covers 1440/390. This covers 768 with the
// same axe ruleset, so all three §5/§8 required widths are actually exercised.
